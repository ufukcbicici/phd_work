...
if __name__ == "__main__":
    ...
    DbLogger.log_db_path = DbLogger.okul
    bayesian_optimizer = FmnistRandomRoutingOptimizer(init_points=100, n_iter=300, xi=0.01)
    bayesian_optimizer.fit(log_file_root_path=os.path.split(os.path.abspath(__file__))[0],
                           log_file_name="bo_fmnist_random_routing")
