...
def residue_network_func(network):
    ...
    residue_logits = tf.matmul(hidden_layer_3, fc_softmax_weights) + fc_softmax_biases
    ...
    network.evalDict["residue_samples"] = network.dataTensor
