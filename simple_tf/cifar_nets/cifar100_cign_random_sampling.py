...
class Cifar100_CignRandomSampling(CignRandomSample):
    ...
    def get_explanation_string(self):
        ...
        explanation = "Resnet-50 Random Sampling CIGN\n"
    ...
    def set_training_parameters(self):
        ...
        GlobalConstants.EPOCH_COUNT_INVALID = 600
        ...
        GlobalConstants.USE_RANDOM_SAMPLING = True
        ...
        self.networkName = "Cifar100_CIGN_Random_Sampling"
