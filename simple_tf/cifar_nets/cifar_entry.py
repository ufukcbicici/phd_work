...
def cifar_100_training():
    ...
    # classification_wd = [0.0003, 0.00035, 0.0004, 0.00045, 0.0005] * GlobalConstants.EXPERIMENT_MULTIPLICATION_FACTOR
    classification_wd = [0.0001, 0.00015] * GlobalConstants.EXPERIMENT_MULTIPLICATION_FACTOR
