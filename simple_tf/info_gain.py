...
class InfoGainLoss:
    ...
    def get_loss(p_n_given_x_2d, p_c_given_x_2d):
        ...
        # Calculate entropies
        entropy_p_cn = InfoGainLoss.calculate_entropy(prob_distribution=marginal_p_cn)
        entropy_p_n = InfoGainLoss.calculate_entropy(prob_distribution=marginal_p_n)
        entropy_p_c = InfoGainLoss.calculate_entropy(prob_distribution=marginal_p_c)
...
ONE_HOT_LABELS = tf.placeholder(name="one_hot_labels", dtype=GlobalConstants.DATA_TYPE)
