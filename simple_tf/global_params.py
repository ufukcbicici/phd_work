...
class GlobalConstants:
    ...
    CLASSIFICATION_DROPOUT_KEEP_PROB = 0.5
    DECISION_DROPOUT_KEEP_PROB = 0.35
    ...
    # Fashion Mnist
    # Baseline
    FASHION_NET_BASELINE_CONV_FEATURE_MAPS = [1, 32, 32, 64]
    ...
    #                                    num_of_features_per_block=[16, 52, 64, 72],
    #                                    first_conv_filter_size=3, relu_leakiness=0.1,
    ...
    INNER_NODE_OUTPUTS_TO_COLLECT = ["indices_tensor", "branch_probs", "activations", "pre_branch_feature",
                                     "branching_feature"]
    LEAF_NODE_OUTPUTS_TO_COLLECT = ["indices_tensor",
                                    "final_feature_final", "posterior_probs", "label_tensor", "logits"]
    ...
    EVALUATION_PERIODS = 1000
    EVALUATION_EPOCHS_BEFORE_ENDING = 15
    ...
    CIGJ_FASHION_NET_H_FEATURES = [32, 32, 32, 32]
    CIGJ_FASHION_NET_H_POOL_SIZES = [4, 3, 2, None]
