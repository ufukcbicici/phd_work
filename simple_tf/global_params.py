...
class GlobalConstants:
    ...
    SOFTMAX_COMPRESSION_STRATEGY = SoftmaxCompressionStrategy.start_with_random_mlp_layer
    ...
    SOFTMAX_DISTILLATION_MLP_LAYER_DROPOUTS = [False, False, False]
    SOFTMAX_DISTILLATION_LR_DECAY = 0.5
    # Softmax Compression Parameters
