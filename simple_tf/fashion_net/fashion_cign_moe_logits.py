...
class FashionCignMoeLogits(CignMixtureOfExpertsLogitEnsemble):
    ...
    def get_explanation_string(self):
        ...
        # Tree
        explanation = "Fashion Net - MoE Logits\n"
    ...
    def set_training_parameters(self):
        ...
        self.networkName = "FashionNet_Lite_MoE_Logits"
    ...
    def set_hyperparameters(self, **kwargs):
        ...
        for node in self.topologicalSortedNodes:
            ...
            node.probThresholdCalculator = FixedParameter(value=initial_value, name=threshold_name)
            # initial_value = 1.0 / float(node_degree)
            # threshold_name = self.get_variable_name(name="prob_threshold_calculator", node=node)
