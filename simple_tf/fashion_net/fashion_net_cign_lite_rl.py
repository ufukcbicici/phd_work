...
from simple_tf.cign.cign_with_rl_routing import CignWithRlRouting
from simple_tf.fashion_net.fashion_cign_lite import FashionCignLite
from simple_tf.global_params import GlobalConstants
from simple_tf.cign.fast_tree import FastTreeNetwork


class FashionCignLiteRl(CignWithRlRouting):
    ...
    def get_explanation_string(self):
        ...
        # Tree
        explanation = "Fashion Net - Reinforcement Learning Based Routing\n"
