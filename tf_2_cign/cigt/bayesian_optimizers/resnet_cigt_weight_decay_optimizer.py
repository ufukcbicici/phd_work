...
class ResnetCigtWeightDecayOptimizer(BayesianOptimizer):
    ...
    def cost_function(self, **kwargs):
        ...
        print("weight_decay={0}".format(kwargs["weight_decay"]))
        ...
        ResnetCigtConstants.softmax_decay_initial = 25.0
        ResnetCigtConstants.softmax_decay_coefficient = 0.9999
        ResnetCigtConstants.softmax_decay_period = 1
        ResnetCigtConstants.softmax_decay_min_limit = 0.1
